/*****
This will take a given compendium, then use that as a basis to update ALL items currently present in the world with the same name with that new compendium data. 
written by: Kandashi
